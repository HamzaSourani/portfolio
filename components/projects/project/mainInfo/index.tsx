        ...
        <div className="flex flex-row gap-4 px-2 pb-2">
          {link && (
            <Link className="transition-transform hover:scale-110" href={link}>
              <BiLink className="h-6 w-6 fill-primary sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-10 lg:w-10" />
            </Link>
          )}
          {sourceCodeUrl && (
            <Link
              ...
              href={sourceCodeUrl}
            >
              <BiLogoGithub className="h-6 w-6 fill-primary sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-10 lg:w-10" />
            </Link>
          )}
        </div>
      </div>
